  ...
  const principles = [
    {
      ...
      description:
        "We understand student challenges. Affordable prices, flexible timelines, and support throughout your journey.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Professional-grade solutions delivered quickly. No compromises on quality, even at student prices.",
      align: "right",
    },
    {
      number: "03",
      ...
      description:
        "We know deadlines matter. Quick turnaround times without sacrificing quality or attention to detail.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "EXPERT ", highlight: false },
        { text: "SUPPORT", highlight: true },
      ],
      description: "Founded by tech enthusiasts. Real expertise from people who have been students too.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">03 / Our Values</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY TECHTONIC</h2>
      </div>
