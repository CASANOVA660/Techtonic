...
const signals = [
  {
    ...
    note: "Full-stack web application for ESPRIT student marketplace with payment integration.",
  },
  {
    date: "2025.03.08",
    title: "Club Management App",
    note: "Mobile app for Tek-Up robotics club with event scheduling and member management.",
  },
  {
    date: "2025.02.28",
    title: "Research Dashboard",
    note: "Data visualization platform for ENSI engineering research project.",
  },
  {
    date: "2025.02.20",
    title: "PFE Support Package",
    note: "Complete graduation project support for SupCom student including report and presentation.",
  },
  {
    date: "2025.02.10",
    title: "Branding & Design",
    note: "Complete visual identity and branding package for Manar startup incubator.",
  },
]
  ...
  return (
    <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-accent">01 / Recent Work</span>
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">LATEST PROJECTS</h2>
      </div>
